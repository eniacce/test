...
(function () {
    ...
    d.parseDefs = function (a, b) {
        for (var c in a) {
            var e = typeof a[c];
            if (0 < a[c].length && "object" == e)for (var h = 0; h < a[c].length; h++)e = document.createElementNS(d.SVG_NS, c), b.appendChild(e), d.parseDefs(a[c][h],
                e); else"object" == e ? (e = document.createElementNS(d.SVG_NS, c), b.appendChild(e), d.parseDefs(a[c], e)) : b.setAttribute(c, a[c])
        }
    }
})();
(function () {
    ...
    d.AxisBase = d.Class({
        ...
        getBBox: function () {
            ...
            var t, z = this.gridAlpha, y, v = this.choosePeriod(0), w = v.period, v = v.count, A = d.getPeriodDuration(w, v);
            A < k && (w = g.period, v = g.count, A = k);
            g = w;
            "WW" == g && (g = "DD");
            this.stepWidth = this.getStepWidth(this.timeDifference);
            var B = Math.ceil(this.timeDifference / A) + 5, C = l = d.resetDateToMin(new Date(this.startTime - A), w, v, r).getTime();
            ...
            if (0 < this.gridCountR)for (B - 5 - k > this.autoRotateCount && !isNaN(this.autoRotateAngle) && (this.labelRotationR = this.autoRotateAngle), a = k; a <= B; a++) {
                ...
                this.pushAxisItem(m);
                m = l = q;
                if (!isNaN(t))for (h = 1; h < v; h += t)this.gridAlpha = this.minorGridAlpha, f = q + y * h, f = d.resetDateToMin(new Date(f), w, t, r).getTime(),
    ...
    d.ValueAxis = d.Class({
        inherits: d.AxisBase, construct: function (a) {
            ...
            if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max)e = !0; else {
                ...
                var t = this.step, E, v = this.minorGridAlpha;
                ...
                if ("date" == c)this.generateDFObject(), this.timeDifference = this.max - this.min, this.maxTime = this.lastTime = this.max, this.startTime = this.firstTime = this.min, this.parseDatesDraw(); else for (r >= this.autoRotateCount && !isNaN(this.autoRotateAngle) && (this.labelRotationR =
                    this.autoRotateAngle), g = f; g < r; g += q)if (c = t * g + this.minCalc, h && this.max - this.min > 10 * this.min && (c -= this.min), c = d.roundTo(c, this.maxDecCount + 1), !this.integersOnly || Math.round(c) == c)if (isNaN(z) || Number(d.toFixed(c, z)) == c) {
            ...
            for (e = a; e <= b; e++) {
                var d =
                    this.data[e].axes[this.id].graphs, f;
            ...
            var c = this.chart;
            "xy" == c.type ? (b < a && (c = b, b = a, a = c), a < this.min && (a = this.min), b > this.max && (b = this.max), c = {type: "axisSelfZoomed"}, c.chart = this.chart, c.valueAxis = this, c.multiplier = this.axisWidth / Math.abs(this.getCoordinate(b) - this.getCoordinate(a)), c.startValue = a, c.endValue = b, c.position = "V" == this.orientation ? this.reversed ? this.getCoordinate(a) : this.getCoordinate(b) :
            ...
            if (isNaN(a))return NaN;
            var b = this.rotate,
                c = this.reversed, e = this.axisWidth, d = this.stepWidth, f = this.min, g = this.minReal;
...
(function () {
    ...
    d.RecItem = d.Class({
        construct: function (a, b, c, e, h, f, g, k, l, m, n, p) {
            ...
            l || (l = 0);
            void 0 == e && (e = !0);
            var r = q.fontFamily, u = a.fontSize;
            ...
            this.set = y;
            var v = a.axisThickness, w = a.axisColor, A = a.axisAlpha, B = a.tickLength, C = a.gridAlpha, D = a.gridThickness, J = a.gridColor, E = a.dashLength, O = a.fillColor, I = a.fillAlpha, W = a.labelsEnabled;
            n = a.labelRotationR;
            var ea = a.counter, P = a.inside, oa = a.labelOffset, qa = a.dx, ka = a.dy, Ra = a.orientation, ca = a.position, aa = a.previousCoord, V = a.viH, sa = a.viW, ba = a.offset, da, ta;
            ...
            var R = n * Math.PI / 180, X, wa, H = 0, x = 0, la = 0, ga = X = 0, Ja = 0;
            "V" == Ra && (n = 0);
            var Z;
            ...
            Z && (Z.attr({"text-anchor": fa}), Z.translate(H, x), 0 !==
    ...
    d.AmChart = d.Class({
        construct: function (a) {
            ...
            if (a) {
                ...
                var f = d.removePx(d.getStyle(a, "padding-left")), g = d.removePx(d.getStyle(a,
        ...
        destroy: function () {
            ...
            if (this.container && !1 !== a.enabled) {
                ...
                var b = a.y, c = a.text, e = a.align, h =
                    a.size, f = a.color, g = a.rotation, k = a.alpha, l = a.bold, m = d.toCoordinate(a.x, this.realWidth), b = d.toCoordinate(b, this.realHeight);
                m || (m = 0);
                b || (b = 0);
                void 0 === f && (f = this.color);
            ...
            if (c != a || !0 === this.inIframe()) {
                ...
                if ("serial" ==
                    g || "xy" == g || "gantt" == g)c = this.marginLeftReal, e = this.marginTopReal, d = c + this.plotAreaWidth, f = e + this.plotAreaHeight;
        ...
        construct: function (a) {
            ...
            for (m = this.start; m <= this.end; m++) {
                ...
                if (isNaN(p))this.connect || (this.drawLineGraph(b, c, e, d), b = [], c = [], e = [], d = []); else {
                    var r = this.y - (this.valueAxis.getCoordinate(p) - this.height), r = r * this.valueAxis.rMultiplier, u = 180 - 360 / (this.end - this.start + 1) * m;
                    ...
                    c.push(r);
                    if (!isNaN(q)) {
                        var t = this.y - (this.valueAxis.getCoordinate(q) - this.height), t = t * this.valueAxis.rMultiplier,
                            z = t * Math.sin(u / 180 * Math.PI), u = t * Math.cos(u / 180 * Math.PI);
                        e.push(z);
                        d.push(u);
                        isNaN(k) && (k = z);
                        isNaN(l) && (l = u)
            ...
            if (e) {
                ...
                var r = l.columnGraphics, u = 0, t = 0;
                r && (u = r.x, t = r.y);
            ...
            isNaN(k) && (k = .8);
            var m = this.useNegativeColorIfDown, n = this.width, p = this.height, q = this.y, r = this.rotate, u = this.columnCount, t = d.toCoordinate(this.cornerRadiusTop, k / 2), z = this.connect, y = [], v = [], w, A, B, C, D = this.chart.graphs.length, J, E = this.dx / this.tcc, O = this.dy / this.tcc, I = f.stackType, W = this.start, ea = this.end, P = this.scrollbar, oa = "graph-column-";
            P && (oa = "scrollbar-graph-column-");
            var qa = this.categoryAxis, ka = this.baseCoord, Ra = this.negativeBase,
                ca = this.columnIndex, aa = this.lineThickness, V = this.lineAlpha, sa = this.lineColorR, ba = this.dashLength, da = this.set, ta, fa = this.getGradRotation(), R = this.chart.columnSpacing, X = qa.cellWidth, wa = (X * k - u) / u;
            R > wa && (R = wa);
            var H, x, la, ga = p + 1, Ja = n + 1, Z = 0, qb = 0, rb, sb, eb, fb, tb = this.fillColorsR, Ka = this.negativeFillColors, Da = this.negativeLineColor, Wa = this.fillAlphas, Xa = this.negativeFillAlphas;
            ...
            if (!(P || "line" != g && "smoothedLine" != g && "step" != g || (1 == e.length && "step" != g && "none" == this.bullet && (this.bullet = "round", this.resetBullet = !0), !Ka && void 0 == Da || m))) {
                ...
                var Ga = f.getCoordinate(Sa), Ib = f.getCoordinate(f.max);
            ...
            if ("line" == g || "step" == g || "smoothedLine" == g) {
                if (0 < W) {
                    ...
                    if (this.lineColorField)for (K =
                                                     W; -1 < K; K--)if (H = e[K], x = H.axes[f.id].graphs[b], x.lineColor) {
            ...
            var Kb = this.noStepRisers, hb = -1E3, ib = -1E3, jb = this.minDistance, Ma = !0, Ya = !1;
            for (K = W; K <= ea; K++) {
                H = e[K];
                ...
                var U, Q, M, ha, ma = NaN, G = NaN, F = NaN, N = NaN, L = NaN,
                    Oa = NaN, Ea = NaN, Pa = NaN, Fa = NaN, ya = NaN, za = NaN, ia = NaN, ja = NaN, Y = NaN, vb = NaN, wb = NaN, na = NaN, pa = void 0, Ia = tb, Ta = Wa, Ba = sa, ua, xa, xb = this.proCandlesticks, kb = this.topRadius, $a = this.pattern;
                ...
                if (Ca) {
                    ...
                    var ma = H.x[qa.id], Ua = this.periodSpan - 1, ra = Math.floor(X / 2) + Math.floor(Ua * X / 2), Aa = ra, lb = 0;
                    ...
                    switch (g) {
                        ...
                        case "candlestick":
                            if (!isNaN(na) && !isNaN(Y)) {
                                ...
                                if (r) {
                                    ...
                                    xb && Y >= na && (Ta = 0);
                                    var pa =
                                        new d.Cuboid(h, M, ha, E, O, Ia, Ta, aa, ua, V, fa, t, r, ba, $a, kb, oa), Bb, Cb;
                        ...
                        case "ohlc":
                            if (!(isNaN(na) || isNaN(vb) || isNaN(wb) || isNaN(Y))) {
                                ...
                                var mb, nb, ob;
                                if (r) {
                                    var Db = F - k / 2, Db = d.fitToBounds(Db, 0, p), Pb = d.fitToBounds(F, 0, p), Eb = F + k / 2, Eb = d.fitToBounds(Eb, 0, p);
                                    nb = d.line(h,
                                    ...
                                    var Fb = G - k / 2, Fb = d.fitToBounds(Fb, 0, n), Qb = d.fitToBounds(G, 0, n), Gb = G + k / 2, Gb = d.fitToBounds(Gb, 0, n);
                    ...
                    if (!P && !isNaN(Y)) {
                        ...
                        if (this.end - this.start <= Rb || 0 === Rb) {
                            var Sb = this.createBullet(x, ia, ja, K), Tb = this.labelText;
                            if (Tb && Sb) {
                            ...
                            if ("regular" == I || "100%" == I) {
                                ...
                                if (Ub) {
                                    ...
                                    var Vb = Qa.getBBox(), Wb = Vb.width, Xb = Vb.height, bb, cb, pb = f.totalTextOffset, Yb = f.totals[K];
                                    Yb && Yb.remove();
                                    var db = 0;
            ...
            var h = this;
            if (1 < a.length) {
                var f = h.set, g = h.chart,
                    k = h.container, l = k.set(), m = k.set();
                f.push(m);
                f.push(l);
                ...
                u && (q = u);
                var u = h.fillColorsR, t = h.fillColorsSwitched;
                t && (u = t);
                var z = h.dashLength;
                (t = h.dashLengthSwitched) && (z = t);
                var t = h.negativeLineColor, y = h.negativeFillColors, v = h.negativeFillAlphas, w = h.baseCoord;
                ...
                if (0 < f || 0 < v)if (p = a.join(";").split(";"), r = b.join(";").split(";"), n = g.type, "serial" == n || "radar" == n ? 0 < c.length ? (c.reverse(), e.reverse(),
            ...
            if (1 < a.length) {
                ...
                h.push(l);
                h.push(k);
                var m = this.lineAlpha, n = this.lineThickness, h = this.dashLength, p = this.fillAlphas, q = this.lineColorR, r = this.fillColorsR, u = this.negativeLineColor, t = this.negativeFillColors, z = this.negativeFillAlphas, y =
                    this.baseCoord, v = this.lineColorSwitched;
                v && (q = v);
            ...
            b && (this.rotate ? (b.translate(-1E3, d), c.translate(-1E3, d)) : (b.translate(e, -1E3),
                c.translate(e, -1E3)), b.animate({opacity: 1, translate: e + "," + d}, f, a), c.animate({
                opacity: 1,
                translate: e + "," + d
            }, f, a))
        }, animate: function (a) {
            ...
            if (!isNaN(b) && !isNaN(c)) {
                ...
                var k = a.values.value, l = this.maxValue, m = this.minValue, n = this.maxBulletSize, p = this.minBulletSize;
                ...
                a.bullet && (f = a.bullet);
                var k =
                    this.bulletBorderThickness, m = this.bulletBorderColorR, n = this.bulletBorderAlpha, u = this.bulletAlpha;
                m || (m = p);
...
(function () {
    ...
    d.ChartCursor = d.Class({
        construct: function (a) {
            ...
            var c = this.chart, e = this.fullWidth, h = c.mouseX - this.x, f = c.mouseY - this.y;
            ...
            if (this.enabled) {
                ...
                var g = c.categoryAxis, k =
                    c.dx, l = c.dy, m = this.x + 1, n = this.y + 1, p = this.width, q = this.height, r = this.data[a], u;
                this.data[a + 1] && (u = this.data[a + 1]);
                this.fireMoved();
                if (r) {
                    var t = r.x[g.id], z = c.rotate, y = this.stepWidth, v = this.categoryBalloon, w = this.firstTime, A = this.lastTime, B = this.cursorPosition, C = this.zooming, D = this.panning, J = c.graphs;
                    if (c.mouseIsOver || C || D || this.forceShow)if (this.forceShow = !1, D) {
                        var k = this.panClickPos, c = this.panClickEndTime, C = this.panClickStartTime, E = this.panClickEnd, m = this.panClickStart, h = (z ? k - f : k - h) / y;
                        if (!g.parseDates ||
                        ...
                        w = this.line;
                        0 < this.cursorAlpha && (z ? (A = 0, y = t + l, e && (y -= g.cellWidth / 2)) : (A = t, y = 0, e && (A -= g.cellWidth / 2)), B = this.animationDuration, 0 < B && !this.zooming ? isNaN(this.previousX) ? w.translate(A, y) : (w.translate(this.previousX, this.previousY), w.animate({translate: A + "," + y}, B, "easeOutSine")) : w.translate(A, y), this.previousX = A, this.previousY = y, w.show());
                        ...
                        b ? (k = {type: "changed"}, k.index = a, k.chart = this.chart, k.zooming = C, k.mostCloseGraph = E, k.position = z ? f : h, k.target = this, c.fire("changed", k), this.fire("changed", k), this.skipZoomDispatch = !1) : (this.skipZoomDispatch = !0, c.updateLegendValues(a));
        ...
        construct: function (a) {
            ...
            if (k) {
                c =
                    k.x + d;
                e = k.y + f;
                var l = k.width, k = k.height, m = this.rotate, n = this.chart, p = this.width, q = this.height, r = n.mouseX, u = n.mouseY;
                a = this.initialMouse;
            ...
            if (a.enabled) {
                ...
                if (m = a.graph) {
                    ...
                    for (r = 0; r < c.length; r++) {
                        var u = c[r].axes[q.id].graphs[m.id].values, t;
        ...
        construct: function (a) {
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    ...
                    var u = this.horizontalPadding, t = this.verticalPadding, z = this.pointerWidth, y = this.pointerOrientation, v = this.cornerRadius, w = c.fontFamily, A = this.fontSize;
                    ...
                    C < g && (C = g);
                    C + D > l && (C = l - D);
                    var k = A + t, m = C + u, t = this.shadowAlpha, E = this.shadowColor, u = this.borderThickness, O = this.bulletSize, I;
...
(function () {
    ...
    d.AmRectangularChart = d.Class({
        inherits: d.AmCoordinateChart, construct: function (a) {
            ...
            var a = this.dx, b = this.dy, c = this.marginLeftReal, e = this.marginTopReal, h = this.plotAreaWidth - 1, f = this.plotAreaHeight - 1, g = this.plotAreaFillColors, k = this.plotAreaFillAlphas,
            ...
            0 !== a && 0 !== b && (g = this.plotAreaFillColors, "object" == typeof g && (g = g[0]), g = d.adjustLuminosity(g, -.15), h = d.polygon(this.container, [0, a, h + a, h, 0], [0, b, b, 0, 0], g, k, 1, l, m), d.setCN(this, h, "plot-area-bottom"), h.translate(c, e + f), this.set.push(h), a = d.polygon(this.container, [0,
                0, a, a, 0], [0, f, f + b, b, 0], g, k, 1, l, m), d.setCN(this, a, "plot-area-left"), a.translate(c, e), this.set.push(a));
...
(function () {
    ...
    d.TrendLine = d.Class({
        construct: function (a) {
            ...
            var a = this;
            a.destroy();
            var b = a.chart, c = b.container, e, h, f, g, k = a.categoryAxis, l = a.initialDate, m = a.initialCategory, n = a.finalDate, p = a.finalCategory, q = a.valueAxis, r = a.valueAxisX, u = a.initialXValue, t = a.finalXValue, z = a.initialValue, y =
                a.finalValue, v = q.recalculateToPercents, w = b.dataDateFormat;
...
(function () {
    ...
    d.wedge = function (a, b, c, e, h, f, g, k, l, m, n, p, q) {
        ...
        g = r(g);
        k = r(k);
        var u = r(g / f * k), t = d.VML, z = 359.5 + f / 100;
        359.94 < z && (z = 359.94);
        h >= z &&
        (h = z);
        var y = 1 / 180 * Math.PI, z = b + Math.sin(e * y) * k, v = c - Math.cos(e * y) * u, w = b + Math.sin(e * y) * f, A = c - Math.cos(e * y) * g, B = b + Math.sin((e + h) * y) * f, C = c - Math.cos((e + h) * y) * g, D = b + Math.sin((e + h) * y) * k, y = c - Math.cos((e + h) * y) * u, J = {
    ...
    d.VMLRenderer = d.Class({
        construct: function (a, b) {
            ...
            if (0 !== Number(b)) {
                ...
                a.paddingLeft = 1;
                c = b * Math.PI / 180;
                var h = Math.cos(c), f = Math.sin(c), g = d.removePx(a.left),
    ...
    d.AmLegend = d.Class({
        construct: function (a) {
            ...
            var a = this.position, b = this.marginLeft + this.titleWidth, c = this.marginRight, e = this.marginTop, h = this.marginBottom, f = this.horizontalGap,
                g = this.div, k = this.divWidth, l = this.maxColumns, m = this.verticalGap, n = this.spacing, p = k - c - b, q = 0, r = 0, u = this.container;
            ...
            if (!1 !== a.visibleInLegend) {
                ...
                if (b.valueText && 0 < b.valueWidth) {
                    ...
                    var k = b.valueText, h = h + b.lx + b.markerLabelGap + b.valueWidth,
                        l = "end";
            ...
            for (c = 0; c < a.length; c++) {
                ...
                if (e)f.value ? h.text(f.value) : h.text(""); else {
                    ...
                    if (void 0 !== f.type) {
                        ...
                        k ? (g = this.valueText,
                        f.legendValueText && (g = f.legendValueText), g = b.formatString(g, k)) : l && b.formatPeriodString && (l = d.massReplace(l, {"[[title]]": f.title}), g = b.formatPeriodString(l, f))
